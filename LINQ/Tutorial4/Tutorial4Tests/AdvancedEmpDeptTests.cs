...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnDistinctJobTitles()
    {
        ...
        var jobs = emps.DistinctBy(x => x.Job).Select(x => x.Job);
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Where(x => x.Mgr != null);
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps.Join(emps, e1 => e1.Mgr, e2 => e2.EmpNo, (e1, e2) => (Employee: e1.EName, Manager: e2.EName));
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps.Select(x => (x.EName, Total: x.Sal + (x.Comm == null ? 0 : x.Comm) ));
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts, e => e.DeptNo, d => d.DeptNo, (e, d) => (e, d))
            .Select(ed => (ed.e.EName, ed.d.DName, Grade: grades.Where(g => ed.e.Sal >= g.Losal && ed.e.Sal <= g.Hisal).Select(g => g.Grade).First()));
